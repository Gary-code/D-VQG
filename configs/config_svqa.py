...
__C.model.change_detector.emb_dim = 1024
...
__C.model.speaker.vocab_size = 97
__C.model.speaker.motion_input_dim = 2048
__C.model.speaker.seq_length = 44  # set it to max_sequence
...
__C.data.vocab_json = '../VideoQG/data/SVQA/vocab.json'
...
__C.data.train_data_path = '../VideoQG/data/SVQA/questions_train.json'
__C.data.val_data_path = '../VideoQG/data/SVQA/questions_val.json'
__C.data.test_data_path = '../VideoQG/data/SVQA/questions_test.json'
__C.data.image_feature_file = '../VideoQG/data/SVQA/video_feats.h5'

__C.data.train = AttrDict()
__C.data.train.batch_size = 36
__C.data.train.seq_per_img = 1
__C.data.train.max_samples = None

__C.data.val = AttrDict()
__C.data.val.batch_size = 128
...
def _check_and_coerce_cfg_value_type(value_a, value_b, key, full_key):
    ...
    elif isinstance(value_a, str) and isinstance(value_b, int):
        value_a = sum(map(int, re.findall(r'[+-]?\d+', value_a)))
    else:
        raise ValueError(
