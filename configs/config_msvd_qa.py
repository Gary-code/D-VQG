...
__C.data.dataset = 'msvd_qa_dataset'
...
__C.data.vocab_json = '../VideoQG/data/MSVD-QA/vocab.json'
...
__C.data.train_data_path = '../VideoQG/data/MSVD-QA/train_qa.json'
__C.data.val_data_path = '../VideoQG/data/MSVD-QA/val_qa.json'
__C.data.test_data_path = '../VideoQG/data/MSVD-QA/test_qa.json'
__C.data.image_feature_file = '../VideoQG/data/MSVD-QA/msvd-qa_appearance_feat_24.h5'
